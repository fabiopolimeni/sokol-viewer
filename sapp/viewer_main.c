...
#define UNIFORM_INDEX_VIEW_PROJ 0
#define UNIFORM_INDEX_LIGHT 1
#define UNIFORM_INDEX_EYE_POS 2
...
void cleanup(void) {
    sg_destroy_buffer(renderer.bindings.vertex_buffers[BUFFER_INDEX_INSTANCE]);
    sg_destroy_buffer(renderer.bindings.vertex_buffers[BUFFER_INDEX_VERTEX]);
    sg_destroy_buffer(renderer.bindings.index_buffer);
    sg_destroy_image(renderer.bindings.fs_images[SAMPLER_INDEX_ALBEDO]);
